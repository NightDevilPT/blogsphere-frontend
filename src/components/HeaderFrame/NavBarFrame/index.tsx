...
const NavBarFrame = ({showNav,setShowNav}:IProps) => {
	...
	return (
		<div className={`w-auto h-auto transition-all duration-300 max-lg:fixed ${showNav?"max-lg:right-0":"max-lg:right-[-100%]"} max-lg:top-0 max-lg:w-full max-lg:h-[100vh] max-lg:backdrop-blur z-50`}>
			<nav className={`w-auto h-auto flex justify-center items-center gap-5 max-lg:w-52 max-lg:h-full max-lg:fixed max-lg:right-0 max-lg:top-0 max-lg:bg-slate-900 max-lg:px-5 max-lg:flex-col max-lg:justify-start max-lg:pt-12`}>
