...
const PageLoading = ({text}:IProps) => {
	return (
		<div className={`w-full h-full fixed left-0 top-0 bg-primary-bg z-[1000] flex justify-center items-center flex-col gap-10`}>
			...
			<div className="text-xl text-primary-fg relative z-50">{text?text:'Loading...'}</div>
		</div>
	);
};
