...
const CardSkeleton = () => {
	...
	return (
		<div
			...
			} rounded flex justify-center items-center flex-col gap-4`}
		>
			<div
			...
			<div className="w-full h-auto relative flex justify-center items-end flex-col gap-[10px]">
				<div
					className={`w-[80px] h-[65px] absolute left-0 top-0 p-1 flex justify-center items-center ${
						theme === "dark" ? "bg-slate-900" : ""
					}`}
				>
					<div
				...
				></div>
				<div
					className={`w-[60%] h-[20px] mt-1 rounded-sm ${
						theme === "dark" ? "bg-slate-800" : ""
					}`}
				></div>
			</div>
